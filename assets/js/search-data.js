...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/myportfolio/";
        ...
        },{id: "nav-ml-theory-series",
          title: "ml theory series",
          description: "",
          section: "Navigation",
          handler: () => {
            window.location.href = "/myportfolio/seminars/";
          },
        },{id: "nav-music",
          title: "music",
          description: "",
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "news-hinglisheval-evaluating-the-effectiveness-of-code-generation-models-on-hinglish-prompts-advisor-prof-viraj-kumar-lab-division-of-electrical-electronics-and-computer-sciences-research-area-computer-science-education-description-this-project-aimed-to-evaluate-code-generation-llms-on-hinglish-prompts-obtained-from-a-translated-humaneval-dataset-the-end-goal-is-to-evaluate-the-effectiveness-of-such-code-gen-llms-in-cs101-courses-in-the-indian-context-role-helped-in-translating-the-humaneval-dataset-to-hinglish-and-evaluating-multiple-code-gen-llms-such-as-gpt-4-gemma-phi-3-polycoder-starcoder-etc-the-evaluation-criteria-used-was-pass-k-and-item-response-theory-irt-technical-stack-huggingface-transformers-openai-api-matplotlib-source-code-link-to-repository-outcome-paper-accepted-for-publication-at-the-indian-control-conference-2025",
          title: 'HinglishEval: Evaluating the Effectiveness of Code-generation Models on Hinglish Prompts Advisor Prof Viraj...',
          description: "",
          section: "News",},{id: "news-towards-uncertainty-aware-alignment-advisor-prof-aditya-gopalan-lab-department-of-electrical-communication-and-engineering-iisc-research-area-reinforcement-learning-description-developed-an-alignment-framework-with-uncertainty-quantification-for-preference-based-rl-this-framework-was-extended-to-llm-alignment-by-modifying-ppo-proximal-policy-optimization-to-account-for-uncertainty-in-the-reward-estimates-of-the-reward-models-being-used-in-the-rlhf-pipeline-role-experimentally-verified-the-llm-alignment-framework-by-modifying-the-rlhf-pipeline-to-include-our-novel-uncertainty-estimation-framework-the-framework-was-tested-on-llms-of-multiple-sizes-gpt-2-qwen2-5-mistral-7b-and-mulitple-reward-models-such-as-custom-ensemble-reward-models-and-prompted-reward-models-such-as-gemini2-0-deepseek-v3-technical-stack-huggingface-transformers-huggingface-transformers-reinforcement-learning-trl-weights-and-biases-outcome-paper-published-pre-print-available",
          title: 'Towards Uncertainty-aware Alignment Advisor Prof. Aditya Gopalan Lab Department of Electrical Communication and...',
          description: "",
          section: "News",},{id: "news-feed-forward-deblurring-in-3dgs-advisor-prof-r-venkatesh-babu-lab-vision-amp-amp-ai-lab-val-iisc-research-area-computer-vision-description-this-project-aims-to-create-a-generalisable-scene-agnostic-deblurring-framework-to-be-integrated-into-3dgs-foundation-models-for-scene-agnostic-scene-deblurring-role-developed-a-deblurring-framework-which-can-be-readily-plugged-into-sota-3dgs-foundation-models-such-as-noposplat-dust3r-etc-to-enable-deblurring-of-scenes-in-a-feed-forward-fashion-current-methods-tackling-scene-deblurring-within-the-3dgs-framework-are-scene-specifc-methods-we-developed-a-scene-agnostic-framework-technical-stack-pytorch-hydra-config-management-blender-pytorch-lightning-weights-and-biases",
          title: 'Feed Forward Deblurring in 3DGS Advisor Prof R. Venkatesh Babu Lab Vision &amp;amp;amp;...',
          description: "",
          section: "News",},{id: "news-reliable-critics-monotonic-improvement-and-convergence-guarantees-for-reinforcement-learning-advisor-prof-gugan-thoppe-and-prof-aditya-gopalan-lab-department-of-computer-science-and-automation-iisc-and-department-of-electrical-communication-and-engineering-iisc-research-area-reinforcement-learning-description-this-project-aimed-to-further-enhance-the-reliable-policy-iteration-rpi-framework-to-augment-multiple-sota-algorithms-such-as-ppo-td3-ddpg-etc-and-test-it-on-diverse-environments-such-as-atari-mujoco-minigrid-the-goal-is-to-establish-new-sota-results-on-these-environments-using-these-rpi-augmented-algorithms-role-designed-a-novel-loss-function-incorporating-the-rpi-framework-to-be-used-as-a-plug-and-play-substitute-in-sota-deep-rl-algorithms-such-as-ppo-td3-ddpg-etc-also-performed-extensive-experiments-on-the-extreme-sparse-reward-minigrid-environment-and-performed-ablation-studies-to-establish-new-baselines-on-minigrid-technical-stack-pytorch-stable-baselines3-wandb-for-logging-and-hyperparameter-sweeps-matplotlib-seaborn-outcome-paper-accepted-for-publication-at-the-indian-control-conference-2025",
          title: 'Reliable Critics: Monotonic Improvement and Convergence Guarantees for Reinforcement Learning Advisor Prof Gugan...',
          description: "",
          section: "News",},{id: "news-finite-time-guarantees-for-multi-timescale-stochastic-approximation-and-hierarchical-reinforcement-learning-advisor-prof-debabrota-basu-lab-inria-scool-research-area-theoretical-machine-learning-description-developing-finite-time-analysis-of-multi-timescale-stochastic-approximation-with-applications-to-hierarchical-reinforcement-learning",
          title: 'Finite-Time Guarantees for Multi-Timescale Stochastic Approximation and Hierarchical Reinforcement Learning Advisor Prof Debabrota...',
          description: "",
          section: "News",},{id: "news-stochastic-analysis-on-graphons-advisor-prof-anant-raj-lab-department-of-computer-science-and-automation-csa-research-area-theoretical-machine-learning-description-studying-gradient-flow-analysis-and-convergence-properties-on-the-space-of-graphons",
          title: 'Stochastic Analysis on Graphons Advisor Prof Anant Raj Lab Department of Computer Science...',
          description: "",
